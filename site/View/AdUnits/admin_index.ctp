<div class="adUnits index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('dfp_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($adUnit['AdUnit']['dfp_id']); ?>&nbsp;</td>
		<td><?php echo h($adUnit['AdUnit']['name']); ?>&nbsp;</td>
		<td><?php echo h($adUnit['AdUnit']['sizes']); ?>&nbsp;</td>
		<td><?php echo h($adUnit['AdUnit']['created']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $adUnit['AdUnit']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $adUnit['AdUnit']['id'])); ?>
