...
<h2><?php echo __('Zona'); ?></h2>
	<dl>
		...
		<dt><?php echo __('Ads'); ?></dt>
		<dd>
			<?php echo h($zona['Zona']['ads']); ?>
			&nbsp;
		</dd>
		...
		<dt><?php echo __('Crreated'); ?></dt>
		<dd>
			<?php echo h($zona['Zona']['crreated']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	<h3><?php echo __('Related Ad Units'); ?></h3>
	<?php if (!empty($zona['AdUnit'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Dfp Id'); ?></th>
	...
	<?php foreach ($zona['AdUnit'] as $adUnit): ?>
		<tr>
			...
			<td><?php echo $adUnit['dfp_id']; ?></td>
			<td><?php echo $adUnit['name']; ?></td>
			<td><?php echo $adUnit['sizes']; ?></td>
