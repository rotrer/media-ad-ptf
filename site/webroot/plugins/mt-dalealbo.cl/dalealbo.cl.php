<?php
/**
 * Plugin Name: DFP Mediatrends - dalealbo.cl
...
if (jQuery("#content_dfp").length > 0) { jQuery("#content_dfp").empty().html(zona78070005); }var zona78070125 = '<div id="zona-78070125" style="width:300px; height:250px;"><script type="text/javascript">googletag.cmd.push(function() { googletag.display("zona-78070125"); });</scr'+'ipt></div>';
if (jQuery("#sidebar_dfp").length > 0) { jQuery("#sidebar_dfp").empty().html(zona78070125); }
		});
	}
	</script>
<?php
