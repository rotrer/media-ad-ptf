...
# Tiempo de Generación: 2014-11-07 15:26:40 +0000
# ************************************************************
...
CREATE TABLE `line_items_ad_units` (
  ...
  `created` datetime DEFAULT NULL,
  PRIMARY KEY (`id`,`line_items_id`,`ad_units_id`),
...
CREATE TABLE `plugins` (
  ...
  `created` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `indx_sites_id` (`sites_id`),
  CONSTRAINT `fk_sites_id` FOREIGN KEY (`sites_id`) REFERENCES `sites` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Volcado de tabla plugins_ad_orders
# ------------------------------------------------------------

DROP TABLE IF EXISTS `plugins_ad_orders`;

CREATE TABLE `plugins_ad_orders` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `plugins_id` int(11) NOT NULL,
  `ad_orders_id` int(11) NOT NULL,
  `created` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_plugins_id_idx` (`plugins_id`),
  KEY `fk_orders_id_idx` (`ad_orders_id`),
  CONSTRAINT `fk_plugins_id` FOREIGN KEY (`plugins_id`) REFERENCES `plugins` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_ad_orders_id` FOREIGN KEY (`ad_orders_id`) REFERENCES `ad_orders` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `users` (`id`, `name`, `username`, `password`, `email`, `role`, `state`, `first_login`, `can_be_deleted`, `created`)
VALUES
	(2,'Cristian','cristianmediatrendscl','669f332ddcbd6a0e7586006f81c9520b15eea93b','cristian@mediatrends.cl','admin','activo',0,0,'2014-09-12 16:51:16'),
	(3,'Mauro','mauromediatrendscl','marp1985','mauro@mediatrends.cl','admin','inactivo',1,1,'2014-09-15 10:36:50');
...
CREATE TABLE `zonas` (
  ...
  `created` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `sites_id_2` (`plugins_id`),
  CONSTRAINT `zonas_ibfk_1` FOREIGN KEY (`plugins_id`) REFERENCES `plugins` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `zonas_ad_units` (
  ...
  `ad_units_id` int(11) NOT NULL,
  `created` datetime DEFAULT NULL,
  PRIMARY KEY (`if`,`zonas_id`,`ad_units_id`),
  KEY `index2` (`zonas_id`),
