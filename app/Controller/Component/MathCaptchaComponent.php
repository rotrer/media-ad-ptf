...
class MathCaptchaComponent extends Component {
  ...
  */
  private $choices = array(
    "Cual es la suma de .:addition-problem:.?", 
    "Que resulta de .:word-problem:.?", 
    "Que es .:problem:.?", 
    "Cual es el resultado de .:word-problem:.?", 
    "Que se obtiene cuando .:word2-problem:.?" 
  ); 
  ...
  */
  private $placeholders = array(
    ...
    ".:operatorword:." => array( 
      "agregas .:number:. a" => "+",
      "multiplicas .:number:. por" => "*"),

    ".:operatorword-ing:." => array(
      "agregar .:number:. a" => "+",
      "multiplicado .:number:. por" => "*")
  );
